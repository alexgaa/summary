...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title text-bold">Sorting works</h3>
        </div>
        <div class="card-body">
            <form action="{{route("experience.sortingWorksUpdate", ['id'=>$experience->id])}}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group ">
                        <p class="bg-primary p-1 ">Works</p>
                        <div class="form-group row mb-0">
                            <div class="col-sm-4">
                                <p class="text-bold mb-2">Job title</p>
                            </div>
                            <div class="col-sm-1">
                        ...
                        @foreach($experience->works as $name)
                            <div class="form-group row mb-1">
                                <label for="works{{$name->id}}" class="col-sm-4 col-form-label">{{$name->name}} :</label>
                                <div class="col-sm-1">
                                    <input name="works[{{$name->id}}]" type="text" id="works{{$name->id}}"
